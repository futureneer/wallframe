"""autogenerated by genmsg_py from TrackerUser.msg. Do not edit."""
...
class TrackerUser(roslib.message.Message):
  _md5sum = "c4f1e9a80fc94f2519473798dffa838a"
  _type = "modulair_msgs/TrackerUser"
...
"""
  ...
  _slot_types = ['Header','uint8','string','string[]','float64[]','geometry_msgs/Transform[]','geometry_msgs/Vector3[]','geometry_msgs/Vector3']
