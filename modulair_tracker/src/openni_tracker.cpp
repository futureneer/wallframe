...
void publishTransform(openni_msgs::User& user_msg, XnUserID const& user, XnSkeletonJoint const& joint, string const& frame_id, string const& child_frame_id, EnumWrapper *kinect) {
...
void publishTransforms(const std::string& frame_id, EnumWrapper *kinect) {
    ...
    static ros::Publisher user_array_publisher = n.advertise<openni_msgs::UserArray>("/modulair/users/raw", 10);

    openni_msgs::UserArray user_array_msg;
